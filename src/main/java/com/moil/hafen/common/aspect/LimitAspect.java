...
import com.moil.hafen.common.domain.LimitType;
import com.moil.hafen.common.exception.LimitAccessException;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.moil.hafen.common.annotation.Limit)")

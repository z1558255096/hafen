package com.moil.hafen.common.generator;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://rm-bp1ss04e17q20v8vyro.mysql.rds.aliyuncs.com:3306/sojourn?useSSL=false&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true";
    // 数据库驱动
    ...
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.panshi.honor";
    // xml文件路径

package com.moil.hafen.common.service.impl;

import com.moil.hafen.common.exception.RedisConnectException;
import com.moil.hafen.common.function.JedisExecutor;
...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public Long increment(String key, Long milliscends) throws RedisConnectException {
        Assert.notNull(key,"key的值不能为空");
        Long result = this.excuteByJedis(j -> j.incr(key.toLowerCase()));
        this.pexpire(key, milliscends);
        return result;
    }

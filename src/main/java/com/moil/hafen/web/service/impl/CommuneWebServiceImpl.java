...
public class CommuneWebServiceImpl implements CommuneWebService {
    ...
    public CommuneWebVo index() {
        ...
        List<CommuneTicket> communeTicketList = communeTicketService.list(new LambdaQueryWrapper<CommuneTicket>().eq(CommuneTicket::getIsShow, 0).eq(CommuneTicket::getStatus, 0));
        List<CommuneActivity> communeActivityList = communeActivityService.list(new LambdaQueryWrapper<CommuneActivity>().eq(CommuneActivity::getIsShow, 0).eq(CommuneActivity::getStatus, 0));
